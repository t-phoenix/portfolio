              ...
              <div className="space-y-3">
                ...
                <div className="text-center mt-4">
                  <a 
                    ...
                    className="text-neutral-500 hover:text-neutral-400 text-xs transition-colors inline-flex items-center gap-1.5 flex-wrap justify-center max-w-full break-all"
                  >
                    <span className="whitespace-nowrap">Contract:</span>
                    <code className="font-mono break-all text-[10px] sm:text-xs">{POTSHOT_CONTRACT_ADDRESS}</code>
